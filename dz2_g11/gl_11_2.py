...
from gl_11_1 import parse_cdp_neighbors

# не понимаю как импортировать прошлый код
...
def create_network_map(filenames):
    ...
    for filename in filenames:
        with open(f'C:/Users/karin/STUDY/2k_2c/Veb_rasr/HW_2/dz2_g11/{filename}') as show_command:
