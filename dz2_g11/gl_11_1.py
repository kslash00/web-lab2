...
def parse_cdp_neighbors(command_output):
    ...
    for line in command_output.split("\n"):
        ...
        if ">" in line:
            ...
            result_dict[(hostname, l_int + l_int_num)] = (r_host, r_int + r_int_num)
    return result_dict


if __name__ == "__main__":
    with open("C:/Users/karin/STUDY/2k_2c/Veb_rasr/HW_2/dz2_g11/sh_cdp_n_sw1.txt") as f:
        print(parse_cdp_neighbors(f.read()))


      ##  C:\Users\karin\STUDY\2k_2c\Veb_rasr\HW_2\dz2_g11